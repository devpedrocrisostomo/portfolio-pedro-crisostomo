...
function ContactCard({ item }) {
  const content = (
    <>
      ...
      <span className="ml-auto text-[color:var(--color-accent)]" aria-hidden="true">→</span>
    </>
  );

  const className =
    'flex items-center gap-4 border-t border-[color:var(--color-rule)] py-5 transition hover:border-[color:var(--color-accent)]';
